...
curve(dnorm(x, mean = mean(datos$tiempo_entrega), sd = sd(datos$tiempo_entrega)),
      add = TRUE,
      lwd = 4,
      col = "orange3");abline(v = mean(datos$tiempo_entrega),
                              lwd = 3,
                              col = "black",
                              lty = 2)
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~+
#      SECCION 2: INFERENCIA ESTADISTICA
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#------------------------------
# Ejericio 1. Clase 5 Unidad 1
#------------------------------
# Resumen Descriptivo tiempo de entrega
descr(datos$tiempo_entrega)
...
# Comprobar distribución normal en los datos
shapiro.test(datos$tiempo_entrega)

# Comprobar hipotesis mu = 25 minutos
t.test(x = datos$tiempo_entrega, mu = 25)

#------------------------------
# Ejericio 2. Clase 5 Unidad 1
#------------------------------
# Resumen Descriptivo tiempo de entrega por punto de venta
stby(datos$tiempo_entrega, datos$punto_venta, descr) 

#Grafico cajas y bigotes tiempo por punto venta

# Comprobar distribución normal en los datos
shapiro.test(datos[datos$punto_venta=="A",]$tiempo_entrega)
shapiro.test(datos[datos$punto_venta=="B",]$tiempo_entrega)

# Comprobar hipotesis diferencia tiempo entrega en los dos puntos
