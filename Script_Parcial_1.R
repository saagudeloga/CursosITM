#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#       PARCIAL 1 - CEP/C 2026 1 : 03 de marzo
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Cargar librerias
require(summarytools)

# Lectura de datos
datos <- read.csv("https://raw.githubusercontent.com/saagudeloga/CursosITM/refs/heads/main/datos_parcial1.csv")
str(datos)
...
#-----------------------------------------------------------------------------
#     PUNTO 3: Intervalo de confianza para la media del peso
#-----------------------------------------------------------------------------
t.test(datos$Peso[datos$Maquina==1],conf.level = 0.95) # IC Peso para máquina 1
t.test(datos$Peso[datos$Maquina==2],conf.level = 0.95) # IC Peso para máquina 2
